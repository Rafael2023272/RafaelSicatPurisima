...
function openCert(card) {
    ...
    document.getElementById('certLightboxImg').alt = title.textContent;
    document.getElementById('certLightboxTitle').textContent = title.textContent;
    document.getElementById('certLightboxIssuer').textContent = issuer.textContent;
    document.getElementById('certLightboxDate').textContent = date.textContent;

    document.getElementById('certBackdrop').classList.add('open');
    document.body.style.overflow = 'hidden';
}

function closeCert() {
    document.getElementById('certBackdrop').classList.remove('open');
    document.body.style.overflow = '';
}
